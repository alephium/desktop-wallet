          ...
          <div className="section">
            ...
            <form noValidate autoComplete="off">
              <TextField
                ...
                id="network.host"
                label="Host"
                value={this.state.networkHost}
                onChange={(e) => this.updateNetworkHost(e)}
              />
              <TextField
                className="field"
                id="network.port"
                label="Port"
                value={this.state.networkPort}
                onChange={(e) => this.updateNetworkPort(e)}
              />
            </form>
          </div>
          <div className="actions">
            <p>
              <Button onClick={(e) => this.save()} variant="contained" className="buttonLarge">
                Save changes
              </Button>
            </p>
            <br />
            <p>
              <Button onClick={(e) => this.logout()} variant="contained" className="buttonLarge">
                Logout
              </Button>
            </p>
            <p>
              <Button onClick={(e) => this.delete()} variant="contained" className="buttonLarge">
                Delete Wallet
              </Button>
            </p>
          </div>
